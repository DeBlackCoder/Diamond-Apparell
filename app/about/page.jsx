...
import preciouslogo from "/public/preciouslogo.png"; // update path if needed
  ...
  return (
    <div className="about-container">
      <header className="about-header">
         <Image
            src={preciouslogo}
            alt="Diamond Apparell Logo"
            width={120}
            height={120}
            className="rounded-full"
          />
        <h1>About Diamond Apparell</h1>
      ...
      <section className="about-story">
        <h2>Our Story</h2>
        <p>
          Founded with passion and purpose, <strong>Diamond Apparell</strong> began as a
